...
#define CUSTOM_MACHINE_NAME "Cube2"
...
#define MAX_BED_POWER 215 // limits duty cycle to bed; 255=full current
  ...
  // Keenovo 180W 150x150cm
  #define  DEFAULT_bedKp 259.07
  #define  DEFAULT_bedKi 47.06
  #define  DEFAULT_bedKd 356.54
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 80, 500, 500 }
...
//  #define Z_SAFE_HOMING_Y_POINT ((Y_BED_SIZE) / 2)    // Y point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_X_POINT 28    // X point for Z homing when homing all axis (G28).
  #define Z_SAFE_HOMING_Y_POINT 2    // Y point for Z homing when homing all axis (G28).
#endif
